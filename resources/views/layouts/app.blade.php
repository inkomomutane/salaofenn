...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2" style="background:none !important;border:none !important; box-shadow:none !important">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand shadow-sm bg-white">
                    <a href="{{ url('/') }}">{{ config('app.name','Fenn\'s Look') }}</a>
                </div>
                <div class="sidebar-brand sidebar-brand-sm shadow-sm bg-white ">
                    <a href="{{ url('/') }}">F'L</a>
                </div>
